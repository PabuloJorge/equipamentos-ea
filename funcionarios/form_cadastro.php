    ...
    <div class="content-wrapper  m-auto" style="width: 90%;">
            ...
            <div class="mb-50">
                <form class="form-horizontal was-validated" method="POST" action="cadastro.php" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="cpf" class="form-control w-25" id="cpf" placeholder="000.000.000-00" required maxlength="14" minlength="11" onkeypress="$(this).mask('000.000.000-00');">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col control-label">Nome</label>
                        <div class="col-sm-10">
                            <input type="text" name="nome" class="form-control w-50" maxlength="100" placeholder="Nome Completo" required>
                        </div>
                    </div>
                    <!-- <div class="form-group">
                        <label class="col control-label">ID COMPUTADOR</label>
                        <div class="col-sm-10">
                            <input type="number" name="computador_id" class="form-control w-25" placeholder="Apenas Números">
                        </div>
                    </div> -->
                    <h5>ID COMPUTADOR</h5>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select name="computador_id" class="form-control w-50">
                                ...
                                $sql = "SELECT * FROM tb_computador WHERE status = 'Inativo' and situacao = 'Reserva';";
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select name="carteira" class="form-control w-25" required>
                                ...
                                <option value="Finsol">Finsol</option>
                                <option value="CNHi">CNHi</option>
                                <option value="DLL">DLL</option>
                                <option value="Shopping">Shopping</option>
                                <option value="Condomínios e Especiais">Condomínios e Especiais</option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="endereco" maxlength="150" placeholder="Logradouro, Nº, Complemento, Bairro - Cidade" class="form-control w-50">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col control-label">AnyDesk</label>
                        <div class="col-sm-10">
                            <input type="number" name="anydesk" maxlength="20" class="form-control w-50">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col control-label">Velocidade do Link</label>
                        <div class="col-sm-10">
                            <input type="number" name="velocidade_link" placeholder="Ex: 150 Mbps" class="form-control w-50">
                        </div>
                    </div>
        ...
        ?>
                <div class="text-center text-danger">
                    <?php echo    '<body onload="alert(' . "'" . 'CPF já cadastrado!' . "'" . ');">'; ?>
                </div>
        <?php
            endif;
            unset($_GET['dadosInvalidos']);
        }
        ?>
