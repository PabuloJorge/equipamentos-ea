                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select name="computador_id" class="form-control w-50" required>
                                <option value="" data-default desabled selected></option>
                                <?php
                                include_once('../bd/conectar.php');
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select name="local" class="form-control w-25" required>
                                ...
                                <option value="Interna" <?php if ($dados['local'] == "Interna") {
                                                            echo "selected";
                                                        } ?>>Interna</option>
                                <option value="Externa" <?php if ($dados['local'] == "Externa") {
                                                            echo "selected";
                                                        } ?>>Externa</option>
                            </select>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select name="status" class="form-control w-25" required>
                                ...
                                <option value="Em andamento" <?php if ($dados['status'] == "Em andamento") {
                                                                    echo "selected";
                                                                } ?>>Em andamento</option>
                                <option value="Finalizada" <?php if ($dados['status'] == "Finalizada") {
                                                                echo "selected";
                                                            } ?>>Finalizada</option>
                            </select>
                        </div>
